...
from multiagent.scenarios.scenario_util import create_noise_field, noise_field

class ENScenario(BaseScenario):
    def make_world(self):
        world = World()
    ...
    def reset_world(self, world):
        ...
        world.agents[0].goal_b = np.random.choice(world.landmarks[:-1])
    ...
    def observation(self, agent, world):
        ...
        obs = noise_field(agent.state.p_pos, world.landmarks[-1].state.p_pos, obs)
        return obs
